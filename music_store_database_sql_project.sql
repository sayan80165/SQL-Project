...
select count(billing_country) as most_invoices,billing_country
from invoice
...
--most money 
select customer.customer_id,customer.first_name,customer.last_name, sum(invoice.total)as most_money
from customer
...
with customer_with_country as(
	select c.customer_id,c.first_name,c.last_name,billing_country,sum(total) as total_spent,
